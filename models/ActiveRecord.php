...
class ActiveRecord {
    ...
    // Busca un registro por su nombre y apellido
    ...
    public static function buscarfolio2($folio) {
        $query = " SELECT * FROM deuda WHERE folio LIKE '%".$folio."%' ";
        $resultado = self::consultarSQL($query);
        return  $resultado  ; 
    }
    public static function buscarap($apellido) {
        $query = " SELECT * FROM cliente WHERE apellido LIKE '%".$apellido."%' ";
        $resultado = self::consultarSQL($query);
        return  $resultado  ; 
    }
    ...
    public static function inscritos($id) {
        $query = "SELECT ci.*, c.* 
